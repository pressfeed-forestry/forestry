...
- Консалтинг
homepage: false
thumbnail: "../assets/uploads/startup_pod_kluch_kotlyarenko.jpg"
...
![](../assets/uploads/startup_pod_kluch_kontacty_RBK.jpg)  
_Пример профиля журналиста_

Будьте готовы, что ответят не все, но кто-то из журналистов обязательно отреагирует и даст обратную связь. Вы сможете договориться о совместном материале.

2) Формировать подписки по ключевым словам, чтобы не пропустить ни одного актуального запроса.

![](../assets/uploads/startup_pod_kluch_podpiski_po_slovam.jpg)  
_Пример подписки_

Конечно, мы мониторим сервис каждый день и внимательно смотрим общую рассылку, но удобно еще и отдельно получать запросы только по нашим темам.

Более того, мы даже сами размещали на Pressfeed один запрос, чтобы найти экспертов для нашего YouTube-блога.

![](../assets/uploads/startup_pod_kluch_zapros.jpg)  
[_Запрос от компании_](https://pressfeed.ru/query/58739)

В итоге нам прислали 16 ответов, и 6 экспертов нам подошли. В общем, теперь используем сервис и как эксперты, и как журналисты :)

## Что мы поняли через 3 месяца с контент-маркетингом

За 3 месяца продвижения через контент мы разместили в медиа около 30 публикаций. 70% сделали через Pressfeed, остальное — через другие платформы или прямые контакты. Планируем продолжать в том же духе и выпускать до 10 материалов с нашим участием ежемесячно.

> Какие выводы можем сделать на данный момент. Контент-маркетинг начинает работать на бизнес практически моментально. Прошел 1 квартал, но мы уже имеем одну подтвержденную конверсию в сделку. Общий трафик на сайт вырос примерно на 15%. Иногда трудно проследить, с какой именно площадки были переходы, но можно увидеть, чтобы они были с внешних ресурсов.

Разумеется, это только то, что мы можем выразить в цифрах. Но никто не отменяет пиар-эффект, влияние контента на имидж, репутацию — как компании, так и меня в качестве руководителя. Ведь в любом случае, даже если мы втянули потенциального клиента в воронку продаж с помощью, например, контекстной рекламы, то он начинает гуглить «Стартап под ключ» в интернете. Видит статьи, комментарии, в итоге доверие растет.

Упоминания в СМИ также влияют на SEO-сайта, цена за клик в контекстной рекламе становится дешевле, растет количество брендовых запросов по компании. Но за такое короткое время пока не можем увидеть все изменения, будем оценивать примерно через год. В это время мы хотим продолжить развивать контент-маркетинг, но уже в другую сторону — недавно запустили видеоблог, а также продумываем обучающий курс для людей, которые хотят открыть свой бизнес в России.