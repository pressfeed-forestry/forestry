...
Словом, выйти на практически любого журналиста всегда можно через Pressfeed.

Как это сделать:

* зайти во вкладку [«СМИ»](https://pressfeed.ru/smi-catalog);
* ввести в поиске нужное издание, например, [«Секрет фирмы»](https://pressfeed.ru/smi/1);
* изучить всех журналистов, которые пишут для портала, посмотреть, на какие темы они писали в последнее время;
* выбрать 1-2 журналиста и написать им со своими предложениями.
